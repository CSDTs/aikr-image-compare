          ...
          {SHOW_HELP && this.state.training === false && (
            <div className={styles.info}>
              ...
              <p>
                ...
                classifier.{" "}
                <a href="https://thekevinscott.github.io/download-image-datasets/">
                  You can download image datasets here.
                </a>
              </p>
              <p>
                <em>
              ...
              <div className={styles.imgContainer}>
                <a
                  target="_blank"
                  href="https://github.com/thekevinscott/ml-classifier-ui/raw/master/example/public/example.gif"
                >
