...
function SelectModal(props) {
	...
	const handleClose = () => {
		...
		for (let i = 0; i < currentList.length; i++) {
			...
			previewTemp.push(<img src={currentList[i].src} alt="" className="col-3 my-2" key={"img" + props.extra + i} />);
		}
		...
		<>
			...
			<Modal show={show} onHide={handleClose} centered size="lg">
				<Modal.Header closeButton>
					<Modal.Title>
						Select Images to {props.extra ? "Train" : "Evaluate"} {props.extra} Model
					</Modal.Title>
				</Modal.Header>
